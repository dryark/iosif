...
c_files := $(wildcard *.c) $(wildcard archiver/*.c) $(wildcard ujsonin/*.c) sandbird/sandbird.c
...
# -DDEBUG -DDEBUG2
iosif: $(iosif_sources)
	gcc -g -I /usr/local/include -o iosif $(c_files) -F ./ -framework CoreFoundation -framework MobileDevice
